...
def create_planet_param_table(results,
    ...
    if paramdict is None:
        paramdict = {
            'p': [r'$p = R_\text{p}/R_\star$', r'\dots'],
            'b': [r'$b = (a_\text{p}/R_\star)\cos i_\text{p}$', r'\dots'],
            'a': [r'$a_\text{p}/R_\star$', r'\dots'],
            'i': [r'$i_\text{p}$', r'deg'],
            'M': [r'$M_\text{p}$', r'$M_\oplus$'],
            'Msini': [r'$M_\text{p}\sin i$', r'$M_\oplus$'],
            'R': [r'$R_\text{p}$', r'$R_\oplus$'],
            'rho': [r'$\rho_\text{p}$', r'\si{\gram\per\centi\meter\cubed}'],
            'g': [r'$g_\text{p}$', r'\si{\meter\per\second\squared}'],
            'au': [r'$a_\text{p}$', r'\si{\astronomicalunit}'],
            'Teq': [
...
def create_planet_posterior_table(results):
    ...
    conversion_dict = {
        ...
        'secosomega_p1': [r'$\sqrt{e_\text{b}}\cos \omega_\text{b}$', r'\dots'],
        'sesinomega_p1': [r'$\sqrt{e_\text{b}}\sin \omega_\text{b}$', r'\dots'],
        'K_p1': [r'$K_\text{b}$', r'$\text{m\,s^{-1}}$'],
        'P_p2': [r'$P_\text{c}$', r'd'],
        't0_p2': [r'$t_{0,c}$', r'd'],
        'r1_p2': [r'$r_{1,c}$', r'\dots'],
        'r2_p2': [r'$r_{2,c}$', r'\dots'],
        'secosomega_p2': [r'$\sqrt{e_\text{c}}\cos \omega_\text{c}$', r'\dots'],
        'sesinomega_p2': [r'$\sqrt{e_\text{c}}\sin \omega_\text{c}$', r'\dots'],
        'K_p2': [r'$K_\text{c}$', r'$\text{m\,s^{-1}}$'],
        'P_p3': [r'$P_\text{d}$', 'd'],
        't0_p3': [r'$t_{0,d}$', r'd'],
        'r1_p3': [r'$r_{1,d}$', r'\dots'],
        'r2_p3': [r'$r_{2,d}$', r'\dots'],
        'secosomega_p3': [r'$\sqrt{e_\text{d}}\cos \omega_\text{d}$', r'\dots'],
        'sesinomega_p3': [r'$\sqrt{e_\text{d}}\sin \omega_\text{d}$', r'\dots'],
        'K_p3': [r'$K_\text{d}$', r'$\text{m\,s^{-1}}$'],
        'GP_period_rv': [r'$P_\text{GP, rv}$', 'd'],
        'GP_sigma_rv': [r'$\sigma_\text{GP, rv}$', r'$\text{m\,s^{-1}}$'],
